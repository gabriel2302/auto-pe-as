        ...
        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$entrada->valor}}</td>
              <td>{{$entrada->status=='1'?'Ativo':'Inativo'}}</td>
              <td>
                ...
                @if($entrada->status=='1')
                <a class="btn btn-danger text-center" onclick="modal_excluir('{{$entrada->nome}}', '{{$entrada->id_entrada}}')" title="Excluir/Inativar"><i class="fa fa-trash"></i></a>
                @else
                <a class="btn btn-success" onclick="modal_ativar('{{$entrada->nome}}', '{{$entrada->id_entrada}}')" title="Ativar"><i class="fa fa-check"></i></a>
                @endif
              </td>
            </tr>
            @endforeach
