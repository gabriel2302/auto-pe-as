...
<div class="row breadcrumb-div">
    <div class="col-md-6">
        <ul class="breadcrumb">
            ...
            <li><a href="/clientes">Entrada de produtos</a></li>
                    ...
                    <div id="campos-cadastro">
                        <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nome-fornecedor" name="nome-fornecedor">
                                </div>

                                <div class="col-md-3 form-group">
                                    <label for="fornecedor">Número da nota fiscal <b>*</b></label>
                                    <input type="text" class="form-control" id="fornecedor" name="fornecedor">
                                </div>

                                <div class="col-md-3 form-group">
                                    <label for="fornecedor">Valor total <b>*</b></label>
                                    <input type="text" class="form-control" id="fornecedor" name="fornecedor">
                                </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" id="valor-venda" name="produto[1][valor-venda]">
                                <input type="hidden" name="node-produto[]" value="1">
                            </div>
